...
activities = {
    ...
    "Basketball Club": {
        ...
        "max_participants": 20,
        "participants": ["josh@mergington.edu", "lisa@mergington.edu"]
    },
    "Drama Club": {
        "description": "Perform plays and learn acting techniques",
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions with labs and quizzes",
